    ...
    return `
        <div class="tv-content">
            <div class="hero">
                ...
                <img src="./github-page/static/img/mname.png" alt="Placeholder image" style="position: absolute;height: 50px;width: 160px;margin: 300px 0px 0px 15px">
                <img src="./github-page/static/img/for-all-mankind.png" alt="Placeholder image">
            </div>
            <div class="cards">
                <div class="row">
                    <img src="./github-page/static/img/for-all-mankind.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/tedlasso.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/monarch.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/hground.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/kflower.png" alt="./github-page/static/video/fam.mp4" >
                </div>
                <div class="row">
                    <img src="./github-page/static/img/family.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/dynasty.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/invasion.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/foundation.png" alt="./github-page/static/video/fam.mp4">
                </div>
                <div class="row">
                    <img src="./github-page/static/img/moa.png" alt="./github-page/static/video/fam.mp4" >
                </div>
            </div>
        </div>
    `;
